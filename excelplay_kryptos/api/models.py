...
class Profile(models.Model):
	...
	def build_profile_model(sender, instance, created, **kwargs):
		if created:
			profile = Profile(user_id=instance)
			profile.save()
...
class Level(models.Model):
	...
	level_file =  models.FileField(upload_to = 'level_files/',blank=True)
	level_image = models.FileField(upload_to = 'level_images/', null=True)
	filetype = models.CharField(max_length = 10,choices=options,default='Image')
	def __str__(self):
